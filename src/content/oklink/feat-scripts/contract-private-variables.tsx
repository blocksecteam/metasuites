...
import type { PostPrivateVariablesParams, PrivateVariablesRes } from '@common/api/types'
...
const genContractPrivateVariables = (address: string) => {
  ...
  createTimerFn(async () => {
    ...
    const readContractItems = readContractBox?.querySelectorAll(META_SUITES_CLASS.contractItem);
